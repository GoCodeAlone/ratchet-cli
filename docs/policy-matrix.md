...
| Dynamic workflows and routines | Deferred | Runtime design exists for visible, bounded workflows and scheduled routines over existing session/team/fleet/cron primitives. JavaScript workflow execution, API/GitHub triggers, and hidden background autonomy are not implemented. |
