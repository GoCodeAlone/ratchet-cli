...
This snapshot was refreshed on 2026-07-02 and updated on 2026-07-03 for the
v0.25.0 release state after the permission-persistence, retro evidence,
Windows release, ACP flow, hook trust, ACP launch profile, raw archive, compare
bundle, and flow replay slices. Repository sources are pinned to the
