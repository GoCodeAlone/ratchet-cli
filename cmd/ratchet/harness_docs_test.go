...
func TestHarnessEmulationDocsCoverPolicyMatrixLayers(t *testing.T) {
	...
	for _, required := range []string{
		...
		"ratchet provider setup guide",
		"ratchet sessions export",
		"ratchet acp config zed",
		"ratchet mcp config zed",
