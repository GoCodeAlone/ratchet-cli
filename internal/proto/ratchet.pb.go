...
const file_internal_proto_ratchet_proto_rawDesc = "" +
	...
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\"\xb1\x02\n" +
	...
	"\aTaskReq\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId2\xd2\x1e\n" +
	"\rRatchetDaemon\x12<\n" +
	...
	"\x16ListSessionCompactions\x12\x1e.ratchet.SessionCompactionsReq\x1a\x1e.ratchet.SessionCompactionList\x129\n" +
...
var file_internal_proto_ratchet_proto_msgTypes = make([]protoimpl.MessageInfo, 102)
var file_internal_proto_ratchet_proto_goTypes = []any{
	...
	(*CompactionRecord)(nil),       // 12: ratchet.CompactionRecord
	(*SessionCompactionList)(nil),  // 13: ratchet.SessionCompactionList
	(*SendMessageReq)(nil),         // 14: ratchet.SendMessageReq
	(*ChatEvent)(nil),              // 15: ratchet.ChatEvent
	(*ThinkingBlock)(nil),          // 16: ratchet.ThinkingBlock
	(*AuthError)(nil),              // 17: ratchet.AuthError
	(*ContextCompressedEvent)(nil), // 18: ratchet.ContextCompressedEvent
	(*TokenDelta)(nil),             // 19: ratchet.TokenDelta
	(*ToolCallStart)(nil),          // 20: ratchet.ToolCallStart
	(*ToolCallResult)(nil),         // 21: ratchet.ToolCallResult
	(*PermissionRequest)(nil),      // 22: ratchet.PermissionRequest
	(*PermissionResponse)(nil),     // 23: ratchet.PermissionResponse
	(*AgentSpawned)(nil),           // 24: ratchet.AgentSpawned
	(*AgentMessage)(nil),           // 25: ratchet.AgentMessage
	(*SessionComplete)(nil),        // 26: ratchet.SessionComplete
	(*ErrorEvent)(nil),             // 27: ratchet.ErrorEvent
	(*SessionHistory)(nil),         // 28: ratchet.SessionHistory
	(*HistoryMessage)(nil),         // 29: ratchet.HistoryMessage
	(*AddProviderReq)(nil),         // 30: ratchet.AddProviderReq
	(*Provider)(nil),               // 31: ratchet.Provider
	(*ProviderList)(nil),           // 32: ratchet.ProviderList
	(*TestProviderReq)(nil),        // 33: ratchet.TestProviderReq
	(*TestProviderResult)(nil),     // 34: ratchet.TestProviderResult
	(*RemoveProviderReq)(nil),      // 35: ratchet.RemoveProviderReq
	(*SetDefaultProviderReq)(nil),  // 36: ratchet.SetDefaultProviderReq
	(*UpdateProviderModelReq)(nil), // 37: ratchet.UpdateProviderModelReq
	(*Agent)(nil),                  // 38: ratchet.Agent
	(*AgentList)(nil),              // 39: ratchet.AgentList
	(*AgentStatusReq)(nil),         // 40: ratchet.AgentStatusReq
	(*StartTeamReq)(nil),           // 41: ratchet.StartTeamReq
	(*TeamEvent)(nil),              // 42: ratchet.TeamEvent
	(*TeamStatusReq)(nil),          // 43: ratchet.TeamStatusReq
	(*TeamStatus)(nil),             // 44: ratchet.TeamStatus
	(*PlanStep)(nil),               // 45: ratchet.PlanStep
	(*Plan)(nil),                   // 46: ratchet.Plan
	(*ApprovePlanReq)(nil),         // 47: ratchet.ApprovePlanReq
	(*RejectPlanReq)(nil),          // 48: ratchet.RejectPlanReq
	(*CronJob)(nil),                // 49: ratchet.CronJob
	(*CreateCronReq)(nil),          // 50: ratchet.CreateCronReq
	(*CronJobList)(nil),            // 51: ratchet.CronJobList
	(*CronJobReq)(nil),             // 52: ratchet.CronJobReq
	(*StartFleetReq)(nil),          // 53: ratchet.StartFleetReq
	(*FleetWorker)(nil),            // 54: ratchet.FleetWorker
	(*FleetStatus)(nil),            // 55: ratchet.FleetStatus
	(*FleetStatusReq)(nil),         // 56: ratchet.FleetStatusReq
	(*KillFleetWorkerReq)(nil),     // 57: ratchet.KillFleetWorkerReq
	(*Job)(nil),                    // 58: ratchet.Job
	(*JobList)(nil),                // 59: ratchet.JobList
	(*JobReq)(nil),                 // 60: ratchet.JobReq
	(*HealthResponse)(nil),         // 61: ratchet.HealthResponse
	(*VersionCheckReq)(nil),        // 62: ratchet.VersionCheckReq
	(*VersionCheckResp)(nil),       // 63: ratchet.VersionCheckResp
	(*ReloadReq)(nil),              // 64: ratchet.ReloadReq
	(*ReloadStatus)(nil),           // 65: ratchet.ReloadStatus
	(*RegisterNodeReq)(nil),        // 66: ratchet.RegisterNodeReq
	(*RegisterNodeResp)(nil),       // 67: ratchet.RegisterNodeResp
	(*BlackboardSync)(nil),         // 68: ratchet.BlackboardSync
	(*MeshEvent)(nil),              // 69: ratchet.MeshEvent
	(*BlackboardEntry)(nil),        // 70: ratchet.BlackboardEntry
	(*BlackboardReadReq)(nil),      // 71: ratchet.BlackboardReadReq
	(*BlackboardReadResp)(nil),     // 72: ratchet.BlackboardReadResp
	(*BlackboardWriteReq)(nil),     // 73: ratchet.BlackboardWriteReq
	(*BlackboardListReq)(nil),      // 74: ratchet.BlackboardListReq
	(*BlackboardListResp)(nil),     // 75: ratchet.BlackboardListResp
	(*ListTeamsReq)(nil),           // 76: ratchet.ListTeamsReq
	(*TeamList)(nil),               // 77: ratchet.TeamList
	(*TeamAddAgentReq)(nil),        // 78: ratchet.TeamAddAgentReq
	(*TeamRemoveAgentReq)(nil),     // 79: ratchet.TeamRemoveAgentReq
	(*TeamRenameReq)(nil),          // 80: ratchet.TeamRenameReq
	(*KillTeamReq)(nil),            // 81: ratchet.KillTeamReq
	(*AttachTeamReq)(nil),          // 82: ratchet.AttachTeamReq
	(*TeamActivityEvent)(nil),      // 83: ratchet.TeamActivityEvent
	(*HumanRequest)(nil),           // 84: ratchet.HumanRequest
	(*HumanResponse)(nil),          // 85: ratchet.HumanResponse
	(*PendingHumanReq)(nil),        // 86: ratchet.PendingHumanReq
	(*PendingHumanList)(nil),       // 87: ratchet.PendingHumanList
	(*SteerTeamReq)(nil),           // 88: ratchet.SteerTeamReq
	(*DirectMessageReq)(nil),       // 89: ratchet.DirectMessageReq
	(*StartProjectReq)(nil),        // 90: ratchet.StartProjectReq
	(*ProjectStatus)(nil),          // 91: ratchet.ProjectStatus
	(*ProjectList)(nil),            // 92: ratchet.ProjectList
	(*ProjectReq)(nil),             // 93: ratchet.ProjectReq
	(*TaskCreateReq)(nil),          // 94: ratchet.TaskCreateReq
	(*TaskUpdateReq)(nil),          // 95: ratchet.TaskUpdateReq
	(*TaskClaimReq)(nil),           // 96: ratchet.TaskClaimReq
	(*TaskListReq)(nil),            // 97: ratchet.TaskListReq
	(*TaskInfo)(nil),               // 98: ratchet.TaskInfo
	(*TaskList)(nil),               // 99: ratchet.TaskList
	(*TaskReq)(nil),                // 100: ratchet.TaskReq
	nil,                            // 101: ratchet.Job.MetadataEntry
	(*timestamppb.Timestamp)(nil),  // 102: google.protobuf.Timestamp
}
var file_internal_proto_ratchet_proto_depIdxs = []int32{
	102, // 0: ratchet.Session.created_at:type_name -> google.protobuf.Timestamp
	1,   // 1: ratchet.SessionList.sessions:type_name -> ratchet.Session
	102, // 2: ratchet.CompactionRecord.created_at:type_name -> google.protobuf.Timestamp
	12,  // 3: ratchet.SessionCompactionList.records:type_name -> ratchet.CompactionRecord
	19,  // 4: ratchet.ChatEvent.token:type_name -> ratchet.TokenDelta
	20,  // 5: ratchet.ChatEvent.tool_start:type_name -> ratchet.ToolCallStart
	21,  // 6: ratchet.ChatEvent.tool_result:type_name -> ratchet.ToolCallResult
	22,  // 7: ratchet.ChatEvent.permission:type_name -> ratchet.PermissionRequest
	24,  // 8: ratchet.ChatEvent.agent_spawned:type_name -> ratchet.AgentSpawned
	25,  // 9: ratchet.ChatEvent.agent_message:type_name -> ratchet.AgentMessage
	26,  // 10: ratchet.ChatEvent.complete:type_name -> ratchet.SessionComplete
	27,  // 11: ratchet.ChatEvent.error:type_name -> ratchet.ErrorEvent
	28,  // 12: ratchet.ChatEvent.history:type_name -> ratchet.SessionHistory
	46,  // 13: ratchet.ChatEvent.plan_proposed:type_name -> ratchet.Plan
	45,  // 14: ratchet.ChatEvent.plan_step_update:type_name -> ratchet.PlanStep
	55,  // 15: ratchet.ChatEvent.fleet_status:type_name -> ratchet.FleetStatus
	18,  // 16: ratchet.ChatEvent.context_compressed:type_name -> ratchet.ContextCompressedEvent
	17,  // 17: ratchet.ChatEvent.auth_error:type_name -> ratchet.AuthError
	16,  // 18: ratchet.ChatEvent.thinking:type_name -> ratchet.ThinkingBlock
	29,  // 19: ratchet.SessionHistory.messages:type_name -> ratchet.HistoryMessage
	102, // 20: ratchet.HistoryMessage.timestamp:type_name -> google.protobuf.Timestamp
	31,  // 21: ratchet.ProviderList.providers:type_name -> ratchet.Provider
	38,  // 22: ratchet.AgentList.agents:type_name -> ratchet.Agent
	24,  // 23: ratchet.TeamEvent.agent_spawned:type_name -> ratchet.AgentSpawned
	25,  // 24: ratchet.TeamEvent.agent_message:type_name -> ratchet.AgentMessage
	19,  // 25: ratchet.TeamEvent.token:type_name -> ratchet.TokenDelta
	20,  // 26: ratchet.TeamEvent.tool_start:type_name -> ratchet.ToolCallStart
	21,  // 27: ratchet.TeamEvent.tool_result:type_name -> ratchet.ToolCallResult
	22,  // 28: ratchet.TeamEvent.permission:type_name -> ratchet.PermissionRequest
	26,  // 29: ratchet.TeamEvent.complete:type_name -> ratchet.SessionComplete
	27,  // 30: ratchet.TeamEvent.error:type_name -> ratchet.ErrorEvent
	38,  // 31: ratchet.TeamStatus.agents:type_name -> ratchet.Agent
	45,  // 32: ratchet.Plan.steps:type_name -> ratchet.PlanStep
	49,  // 33: ratchet.CronJobList.jobs:type_name -> ratchet.CronJob
	54,  // 34: ratchet.FleetStatus.workers:type_name -> ratchet.FleetWorker
	101, // 35: ratchet.Job.metadata:type_name -> ratchet.Job.MetadataEntry
	58,  // 36: ratchet.JobList.jobs:type_name -> ratchet.Job
	68,  // 37: ratchet.MeshEvent.blackboard_sync:type_name -> ratchet.BlackboardSync
	25,  // 38: ratchet.MeshEvent.agent_message:type_name -> ratchet.AgentMessage
	67,  // 39: ratchet.MeshEvent.node_registered:type_name -> ratchet.RegisterNodeResp
	70,  // 40: ratchet.BlackboardReadResp.entry:type_name -> ratchet.BlackboardEntry
	70,  // 41: ratchet.BlackboardListResp.entries:type_name -> ratchet.BlackboardEntry
	44,  // 42: ratchet.TeamList.teams:type_name -> ratchet.TeamStatus
	25,  // 43: ratchet.TeamActivityEvent.agent_message:type_name -> ratchet.AgentMessage
	19,  // 44: ratchet.TeamActivityEvent.token:type_name -> ratchet.TokenDelta
	27,  // 45: ratchet.TeamActivityEvent.error:type_name -> ratchet.ErrorEvent
	26,  // 46: ratchet.TeamActivityEvent.complete:type_name -> ratchet.SessionComplete
	84,  // 47: ratchet.TeamActivityEvent.human_request:type_name -> ratchet.HumanRequest
	84,  // 48: ratchet.PendingHumanList.requests:type_name -> ratchet.HumanRequest
	91,  // 49: ratchet.ProjectList.projects:type_name -> ratchet.ProjectStatus
	98,  // 50: ratchet.TaskList.tasks:type_name -> ratchet.TaskInfo
	...
	4,   // 58: ratchet.RatchetDaemon.AttachSession:input_type -> ratchet.AttachReq
	5,   // 59: ratchet.RatchetDaemon.DetachSession:input_type -> ratchet.DetachReq
	6,   // 60: ratchet.RatchetDaemon.KillSession:input_type -> ratchet.KillReq
	14,  // 61: ratchet.RatchetDaemon.SendMessage:input_type -> ratchet.SendMessageReq
	23,  // 62: ratchet.RatchetDaemon.RespondToPermission:input_type -> ratchet.PermissionResponse
	30,  // 63: ratchet.RatchetDaemon.AddProvider:input_type -> ratchet.AddProviderReq
	0,   // 64: ratchet.RatchetDaemon.ListProviders:input_type -> ratchet.Empty
	33,  // 65: ratchet.RatchetDaemon.TestProvider:input_type -> ratchet.TestProviderReq
	35,  // 66: ratchet.RatchetDaemon.RemoveProvider:input_type -> ratchet.RemoveProviderReq
	36,  // 67: ratchet.RatchetDaemon.SetDefaultProvider:input_type -> ratchet.SetDefaultProviderReq
	37,  // 68: ratchet.RatchetDaemon.UpdateProviderModel:input_type -> ratchet.UpdateProviderModelReq
	0,   // 69: ratchet.RatchetDaemon.ListAgents:input_type -> ratchet.Empty
	40,  // 70: ratchet.RatchetDaemon.GetAgentStatus:input_type -> ratchet.AgentStatusReq
	41,  // 71: ratchet.RatchetDaemon.StartTeam:input_type -> ratchet.StartTeamReq
	43,  // 72: ratchet.RatchetDaemon.GetTeamStatus:input_type -> ratchet.TeamStatusReq
	47,  // 73: ratchet.RatchetDaemon.ApprovePlan:input_type -> ratchet.ApprovePlanReq
	48,  // 74: ratchet.RatchetDaemon.RejectPlan:input_type -> ratchet.RejectPlanReq
	53,  // 75: ratchet.RatchetDaemon.StartFleet:input_type -> ratchet.StartFleetReq
	56,  // 76: ratchet.RatchetDaemon.GetFleetStatus:input_type -> ratchet.FleetStatusReq
	57,  // 77: ratchet.RatchetDaemon.KillFleetWorker:input_type -> ratchet.KillFleetWorkerReq
	50,  // 78: ratchet.RatchetDaemon.CreateCron:input_type -> ratchet.CreateCronReq
	0,   // 79: ratchet.RatchetDaemon.ListCrons:input_type -> ratchet.Empty
	52,  // 80: ratchet.RatchetDaemon.PauseCron:input_type -> ratchet.CronJobReq
	52,  // 81: ratchet.RatchetDaemon.ResumeCron:input_type -> ratchet.CronJobReq
	52,  // 82: ratchet.RatchetDaemon.StopCron:input_type -> ratchet.CronJobReq
	0,   // 83: ratchet.RatchetDaemon.ListJobs:input_type -> ratchet.Empty
	60,  // 84: ratchet.RatchetDaemon.PauseJob:input_type -> ratchet.JobReq
	60,  // 85: ratchet.RatchetDaemon.ResumeJob:input_type -> ratchet.JobReq
	60,  // 86: ratchet.RatchetDaemon.KillJob:input_type -> ratchet.JobReq
	0,   // 87: ratchet.RatchetDaemon.Health:input_type -> ratchet.Empty
	0,   // 88: ratchet.RatchetDaemon.Shutdown:input_type -> ratchet.Empty
	62,  // 89: ratchet.RatchetDaemon.CheckVersion:input_type -> ratchet.VersionCheckReq
	64,  // 90: ratchet.RatchetDaemon.RequestReload:input_type -> ratchet.ReloadReq
	66,  // 91: ratchet.RatchetDaemon.RegisterMeshNode:input_type -> ratchet.RegisterNodeReq
	69,  // 92: ratchet.RatchetDaemon.MeshStream:input_type -> ratchet.MeshEvent
	71,  // 93: ratchet.RatchetDaemon.BlackboardRead:input_type -> ratchet.BlackboardReadReq
	73,  // 94: ratchet.RatchetDaemon.BlackboardWrite:input_type -> ratchet.BlackboardWriteReq
	74,  // 95: ratchet.RatchetDaemon.BlackboardList:input_type -> ratchet.BlackboardListReq
	76,  // 96: ratchet.RatchetDaemon.ListTeams:input_type -> ratchet.ListTeamsReq
	81,  // 97: ratchet.RatchetDaemon.KillTeam:input_type -> ratchet.KillTeamReq
	80,  // 98: ratchet.RatchetDaemon.RenameTeam:input_type -> ratchet.TeamRenameReq
	78,  // 99: ratchet.RatchetDaemon.TeamAddAgent:input_type -> ratchet.TeamAddAgentReq
	79,  // 100: ratchet.RatchetDaemon.TeamRemoveAgent:input_type -> ratchet.TeamRemoveAgentReq
	82,  // 101: ratchet.RatchetDaemon.AttachTeam:input_type -> ratchet.AttachTeamReq
	88,  // 102: ratchet.RatchetDaemon.SteerTeam:input_type -> ratchet.SteerTeamReq
	89,  // 103: ratchet.RatchetDaemon.DirectMessage:input_type -> ratchet.DirectMessageReq
	85,  // 104: ratchet.RatchetDaemon.RespondToHuman:input_type -> ratchet.HumanResponse
	86,  // 105: ratchet.RatchetDaemon.ListPendingHuman:input_type -> ratchet.PendingHumanReq
	90,  // 106: ratchet.RatchetDaemon.StartProject:input_type -> ratchet.StartProjectReq
	0,   // 107: ratchet.RatchetDaemon.ListProjects:input_type -> ratchet.Empty
	93,  // 108: ratchet.RatchetDaemon.PauseProject:input_type -> ratchet.ProjectReq
	93,  // 109: ratchet.RatchetDaemon.ResumeProject:input_type -> ratchet.ProjectReq
	93,  // 110: ratchet.RatchetDaemon.KillProject:input_type -> ratchet.ProjectReq
	93,  // 111: ratchet.RatchetDaemon.GetProjectStatus:input_type -> ratchet.ProjectReq
	94,  // 112: ratchet.RatchetDaemon.CreateTask:input_type -> ratchet.TaskCreateReq
	96,  // 113: ratchet.RatchetDaemon.ClaimTask:input_type -> ratchet.TaskClaimReq
	95,  // 114: ratchet.RatchetDaemon.UpdateTask:input_type -> ratchet.TaskUpdateReq
	97,  // 115: ratchet.RatchetDaemon.ListTasks:input_type -> ratchet.TaskListReq
	100, // 116: ratchet.RatchetDaemon.GetTask:input_type -> ratchet.TaskReq
	1,   // 117: ratchet.RatchetDaemon.CreateSession:output_type -> ratchet.Session
	3,   // 118: ratchet.RatchetDaemon.ListSessions:output_type -> ratchet.SessionList
	28,  // 119: ratchet.RatchetDaemon.ListSessionMessages:output_type -> ratchet.SessionHistory
	1,   // 120: ratchet.RatchetDaemon.CloneSession:output_type -> ratchet.Session
	1,   // 121: ratchet.RatchetDaemon.ForkSession:output_type -> ratchet.Session
	3,   // 122: ratchet.RatchetDaemon.GetSessionTree:output_type -> ratchet.SessionList
	13,  // 123: ratchet.RatchetDaemon.ListSessionCompactions:output_type -> ratchet.SessionCompactionList
	15,  // 124: ratchet.RatchetDaemon.AttachSession:output_type -> ratchet.ChatEvent
	0,   // 125: ratchet.RatchetDaemon.DetachSession:output_type -> ratchet.Empty
	0,   // 126: ratchet.RatchetDaemon.KillSession:output_type -> ratchet.Empty
	15,  // 127: ratchet.RatchetDaemon.SendMessage:output_type -> ratchet.ChatEvent
	0,   // 128: ratchet.RatchetDaemon.RespondToPermission:output_type -> ratchet.Empty
	31,  // 129: ratchet.RatchetDaemon.AddProvider:output_type -> ratchet.Provider
	32,  // 130: ratchet.RatchetDaemon.ListProviders:output_type -> ratchet.ProviderList
	34,  // 131: ratchet.RatchetDaemon.TestProvider:output_type -> ratchet.TestProviderResult
	0,   // 132: ratchet.RatchetDaemon.RemoveProvider:output_type -> ratchet.Empty
	0,   // 133: ratchet.RatchetDaemon.SetDefaultProvider:output_type -> ratchet.Empty
	0,   // 134: ratchet.RatchetDaemon.UpdateProviderModel:output_type -> ratchet.Empty
	39,  // 135: ratchet.RatchetDaemon.ListAgents:output_type -> ratchet.AgentList
	38,  // 136: ratchet.RatchetDaemon.GetAgentStatus:output_type -> ratchet.Agent
	42,  // 137: ratchet.RatchetDaemon.StartTeam:output_type -> ratchet.TeamEvent
	44,  // 138: ratchet.RatchetDaemon.GetTeamStatus:output_type -> ratchet.TeamStatus
	15,  // 139: ratchet.RatchetDaemon.ApprovePlan:output_type -> ratchet.ChatEvent
	0,   // 140: ratchet.RatchetDaemon.RejectPlan:output_type -> ratchet.Empty
	15,  // 141: ratchet.RatchetDaemon.StartFleet:output_type -> ratchet.ChatEvent
	55,  // 142: ratchet.RatchetDaemon.GetFleetStatus:output_type -> ratchet.FleetStatus
	0,   // 143: ratchet.RatchetDaemon.KillFleetWorker:output_type -> ratchet.Empty
	49,  // 144: ratchet.RatchetDaemon.CreateCron:output_type -> ratchet.CronJob
	51,  // 145: ratchet.RatchetDaemon.ListCrons:output_type -> ratchet.CronJobList
	0,   // 146: ratchet.RatchetDaemon.PauseCron:output_type -> ratchet.Empty
	0,   // 147: ratchet.RatchetDaemon.ResumeCron:output_type -> ratchet.Empty
	0,   // 148: ratchet.RatchetDaemon.StopCron:output_type -> ratchet.Empty
	59,  // 149: ratchet.RatchetDaemon.ListJobs:output_type -> ratchet.JobList
	0,   // 150: ratchet.RatchetDaemon.PauseJob:output_type -> ratchet.Empty
	0,   // 151: ratchet.RatchetDaemon.ResumeJob:output_type -> ratchet.Empty
	0,   // 152: ratchet.RatchetDaemon.KillJob:output_type -> ratchet.Empty
	61,  // 153: ratchet.RatchetDaemon.Health:output_type -> ratchet.HealthResponse
	0,   // 154: ratchet.RatchetDaemon.Shutdown:output_type -> ratchet.Empty
	63,  // 155: ratchet.RatchetDaemon.CheckVersion:output_type -> ratchet.VersionCheckResp
	65,  // 156: ratchet.RatchetDaemon.RequestReload:output_type -> ratchet.ReloadStatus
	67,  // 157: ratchet.RatchetDaemon.RegisterMeshNode:output_type -> ratchet.RegisterNodeResp
	69,  // 158: ratchet.RatchetDaemon.MeshStream:output_type -> ratchet.MeshEvent
	72,  // 159: ratchet.RatchetDaemon.BlackboardRead:output_type -> ratchet.BlackboardReadResp
	70,  // 160: ratchet.RatchetDaemon.BlackboardWrite:output_type -> ratchet.BlackboardEntry
	75,  // 161: ratchet.RatchetDaemon.BlackboardList:output_type -> ratchet.BlackboardListResp
	77,  // 162: ratchet.RatchetDaemon.ListTeams:output_type -> ratchet.TeamList
	0,   // 163: ratchet.RatchetDaemon.KillTeam:output_type -> ratchet.Empty
	0,   // 164: ratchet.RatchetDaemon.RenameTeam:output_type -> ratchet.Empty
	0,   // 165: ratchet.RatchetDaemon.TeamAddAgent:output_type -> ratchet.Empty
	0,   // 166: ratchet.RatchetDaemon.TeamRemoveAgent:output_type -> ratchet.Empty
	83,  // 167: ratchet.RatchetDaemon.AttachTeam:output_type -> ratchet.TeamActivityEvent
	0,   // 168: ratchet.RatchetDaemon.SteerTeam:output_type -> ratchet.Empty
	0,   // 169: ratchet.RatchetDaemon.DirectMessage:output_type -> ratchet.Empty
	0,   // 170: ratchet.RatchetDaemon.RespondToHuman:output_type -> ratchet.Empty
	87,  // 171: ratchet.RatchetDaemon.ListPendingHuman:output_type -> ratchet.PendingHumanList
	91,  // 172: ratchet.RatchetDaemon.StartProject:output_type -> ratchet.ProjectStatus
	92,  // 173: ratchet.RatchetDaemon.ListProjects:output_type -> ratchet.ProjectList
	0,   // 174: ratchet.RatchetDaemon.PauseProject:output_type -> ratchet.Empty
	0,   // 175: ratchet.RatchetDaemon.ResumeProject:output_type -> ratchet.Empty
	0,   // 176: ratchet.RatchetDaemon.KillProject:output_type -> ratchet.Empty
	91,  // 177: ratchet.RatchetDaemon.GetProjectStatus:output_type -> ratchet.ProjectStatus
	98,  // 178: ratchet.RatchetDaemon.CreateTask:output_type -> ratchet.TaskInfo
	98,  // 179: ratchet.RatchetDaemon.ClaimTask:output_type -> ratchet.TaskInfo
	98,  // 180: ratchet.RatchetDaemon.UpdateTask:output_type -> ratchet.TaskInfo
	99,  // 181: ratchet.RatchetDaemon.ListTasks:output_type -> ratchet.TaskList
	98,  // 182: ratchet.RatchetDaemon.GetTask:output_type -> ratchet.TaskInfo
...
func file_internal_proto_ratchet_proto_init() {
	...
	file_internal_proto_ratchet_proto_msgTypes[15].OneofWrappers = []any{
		(*ChatEvent_Token)(nil),
	...
	file_internal_proto_ratchet_proto_msgTypes[42].OneofWrappers = []any{
	...
	file_internal_proto_ratchet_proto_msgTypes[69].OneofWrappers = []any{
		(*MeshEvent_BlackboardSync)(nil),
		(*MeshEvent_AgentMessage)(nil),
		(*MeshEvent_NodeRegistered)(nil),
	}
	file_internal_proto_ratchet_proto_msgTypes[83].OneofWrappers = []any{
