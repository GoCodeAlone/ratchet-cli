...
const file_internal_proto_ratchet_proto_rawDesc = "" +
	...
	"\n" +
	"MeshStream\x12\x12.ratchet.MeshEvent\x1a\x12.ratchet.MeshEvent(\x010\x01B3Z1github.com/GoCodeAlone/ratchet-cli/internal/protob\x06proto3"
...
var file_internal_proto_ratchet_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_internal_proto_ratchet_proto_goTypes = []any{
	...
	nil,                            // 63: ratchet.Job.MetadataEntry
	(*timestamppb.Timestamp)(nil),  // 64: google.protobuf.Timestamp
}
var file_internal_proto_ratchet_proto_depIdxs = []int32{
	64, // 0: ratchet.Session.created_at:type_name -> google.protobuf.Timestamp
	...
	64, // 18: ratchet.HistoryMessage.timestamp:type_name -> google.protobuf.Timestamp
	...
	63, // 33: ratchet.Job.metadata:type_name -> ratchet.Job.MetadataEntry
	...
	2,  // 38: ratchet.RatchetDaemon.CreateSession:input_type -> ratchet.CreateSessionReq
	0,  // 39: ratchet.RatchetDaemon.ListSessions:input_type -> ratchet.Empty
	4,  // 40: ratchet.RatchetDaemon.AttachSession:input_type -> ratchet.AttachReq
	5,  // 41: ratchet.RatchetDaemon.DetachSession:input_type -> ratchet.DetachReq
	6,  // 42: ratchet.RatchetDaemon.KillSession:input_type -> ratchet.KillReq
	7,  // 43: ratchet.RatchetDaemon.SendMessage:input_type -> ratchet.SendMessageReq
	16, // 44: ratchet.RatchetDaemon.RespondToPermission:input_type -> ratchet.PermissionResponse
	23, // 45: ratchet.RatchetDaemon.AddProvider:input_type -> ratchet.AddProviderReq
	0,  // 46: ratchet.RatchetDaemon.ListProviders:input_type -> ratchet.Empty
	26, // 47: ratchet.RatchetDaemon.TestProvider:input_type -> ratchet.TestProviderReq
	28, // 48: ratchet.RatchetDaemon.RemoveProvider:input_type -> ratchet.RemoveProviderReq
	29, // 49: ratchet.RatchetDaemon.SetDefaultProvider:input_type -> ratchet.SetDefaultProviderReq
	30, // 50: ratchet.RatchetDaemon.UpdateProviderModel:input_type -> ratchet.UpdateProviderModelReq
	0,  // 51: ratchet.RatchetDaemon.ListAgents:input_type -> ratchet.Empty
	33, // 52: ratchet.RatchetDaemon.GetAgentStatus:input_type -> ratchet.AgentStatusReq
	34, // 53: ratchet.RatchetDaemon.StartTeam:input_type -> ratchet.StartTeamReq
	36, // 54: ratchet.RatchetDaemon.GetTeamStatus:input_type -> ratchet.TeamStatusReq
	40, // 55: ratchet.RatchetDaemon.ApprovePlan:input_type -> ratchet.ApprovePlanReq
	41, // 56: ratchet.RatchetDaemon.RejectPlan:input_type -> ratchet.RejectPlanReq
	46, // 57: ratchet.RatchetDaemon.StartFleet:input_type -> ratchet.StartFleetReq
	49, // 58: ratchet.RatchetDaemon.GetFleetStatus:input_type -> ratchet.FleetStatusReq
	50, // 59: ratchet.RatchetDaemon.KillFleetWorker:input_type -> ratchet.KillFleetWorkerReq
	43, // 60: ratchet.RatchetDaemon.CreateCron:input_type -> ratchet.CreateCronReq
	0,  // 61: ratchet.RatchetDaemon.ListCrons:input_type -> ratchet.Empty
	45, // 62: ratchet.RatchetDaemon.PauseCron:input_type -> ratchet.CronJobReq
	45, // 63: ratchet.RatchetDaemon.ResumeCron:input_type -> ratchet.CronJobReq
	45, // 64: ratchet.RatchetDaemon.StopCron:input_type -> ratchet.CronJobReq
	0,  // 65: ratchet.RatchetDaemon.ListJobs:input_type -> ratchet.Empty
	53, // 66: ratchet.RatchetDaemon.PauseJob:input_type -> ratchet.JobReq
	53, // 67: ratchet.RatchetDaemon.ResumeJob:input_type -> ratchet.JobReq
	53, // 68: ratchet.RatchetDaemon.KillJob:input_type -> ratchet.JobReq
	0,  // 69: ratchet.RatchetDaemon.Health:input_type -> ratchet.Empty
	0,  // 70: ratchet.RatchetDaemon.Shutdown:input_type -> ratchet.Empty
	55, // 71: ratchet.RatchetDaemon.CheckVersion:input_type -> ratchet.VersionCheckReq
	57, // 72: ratchet.RatchetDaemon.RequestReload:input_type -> ratchet.ReloadReq
	59, // 73: ratchet.RatchetDaemon.RegisterMeshNode:input_type -> ratchet.RegisterNodeReq
	62, // 74: ratchet.RatchetDaemon.MeshStream:input_type -> ratchet.MeshEvent
	1,  // 75: ratchet.RatchetDaemon.CreateSession:output_type -> ratchet.Session
	3,  // 76: ratchet.RatchetDaemon.ListSessions:output_type -> ratchet.SessionList
	8,  // 77: ratchet.RatchetDaemon.AttachSession:output_type -> ratchet.ChatEvent
	0,  // 78: ratchet.RatchetDaemon.DetachSession:output_type -> ratchet.Empty
	0,  // 79: ratchet.RatchetDaemon.KillSession:output_type -> ratchet.Empty
	8,  // 80: ratchet.RatchetDaemon.SendMessage:output_type -> ratchet.ChatEvent
	0,  // 81: ratchet.RatchetDaemon.RespondToPermission:output_type -> ratchet.Empty
	24, // 82: ratchet.RatchetDaemon.AddProvider:output_type -> ratchet.Provider
	25, // 83: ratchet.RatchetDaemon.ListProviders:output_type -> ratchet.ProviderList
	27, // 84: ratchet.RatchetDaemon.TestProvider:output_type -> ratchet.TestProviderResult
	0,  // 85: ratchet.RatchetDaemon.RemoveProvider:output_type -> ratchet.Empty
	0,  // 86: ratchet.RatchetDaemon.SetDefaultProvider:output_type -> ratchet.Empty
	0,  // 87: ratchet.RatchetDaemon.UpdateProviderModel:output_type -> ratchet.Empty
	32, // 88: ratchet.RatchetDaemon.ListAgents:output_type -> ratchet.AgentList
	31, // 89: ratchet.RatchetDaemon.GetAgentStatus:output_type -> ratchet.Agent
	35, // 90: ratchet.RatchetDaemon.StartTeam:output_type -> ratchet.TeamEvent
	37, // 91: ratchet.RatchetDaemon.GetTeamStatus:output_type -> ratchet.TeamStatus
	8,  // 92: ratchet.RatchetDaemon.ApprovePlan:output_type -> ratchet.ChatEvent
	0,  // 93: ratchet.RatchetDaemon.RejectPlan:output_type -> ratchet.Empty
	8,  // 94: ratchet.RatchetDaemon.StartFleet:output_type -> ratchet.ChatEvent
	48, // 95: ratchet.RatchetDaemon.GetFleetStatus:output_type -> ratchet.FleetStatus
	0,  // 96: ratchet.RatchetDaemon.KillFleetWorker:output_type -> ratchet.Empty
	42, // 97: ratchet.RatchetDaemon.CreateCron:output_type -> ratchet.CronJob
	44, // 98: ratchet.RatchetDaemon.ListCrons:output_type -> ratchet.CronJobList
	0,  // 99: ratchet.RatchetDaemon.PauseCron:output_type -> ratchet.Empty
	0,  // 100: ratchet.RatchetDaemon.ResumeCron:output_type -> ratchet.Empty
	0,  // 101: ratchet.RatchetDaemon.StopCron:output_type -> ratchet.Empty
	52, // 102: ratchet.RatchetDaemon.ListJobs:output_type -> ratchet.JobList
	0,  // 103: ratchet.RatchetDaemon.PauseJob:output_type -> ratchet.Empty
	0,  // 104: ratchet.RatchetDaemon.ResumeJob:output_type -> ratchet.Empty
	0,  // 105: ratchet.RatchetDaemon.KillJob:output_type -> ratchet.Empty
	54, // 106: ratchet.RatchetDaemon.Health:output_type -> ratchet.HealthResponse
	0,  // 107: ratchet.RatchetDaemon.Shutdown:output_type -> ratchet.Empty
	56, // 108: ratchet.RatchetDaemon.CheckVersion:output_type -> ratchet.VersionCheckResp
	58, // 109: ratchet.RatchetDaemon.RequestReload:output_type -> ratchet.ReloadStatus
	60, // 110: ratchet.RatchetDaemon.RegisterMeshNode:output_type -> ratchet.RegisterNodeResp
	62, // 111: ratchet.RatchetDaemon.MeshStream:output_type -> ratchet.MeshEvent
