...
const file_internal_proto_ratchet_proto_rawDesc = "" +
	...
	"\aTaskReq\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId2\x94\x1a\n" +
	"\rRatchetDaemon\x12<\n" +
	...
	"\n" +
	"MeshStream\x12\x12.ratchet.MeshEvent\x1a\x12.ratchet.MeshEvent(\x010\x01\x125\n" +
...
var file_internal_proto_ratchet_proto_msgTypes = make([]protoimpl.MessageInfo, 89)
var file_internal_proto_ratchet_proto_goTypes = []any{
	...
	(*ListTeamsReq)(nil),           // 63: ratchet.ListTeamsReq
	(*TeamList)(nil),               // 64: ratchet.TeamList
	(*TeamAddAgentReq)(nil),        // 65: ratchet.TeamAddAgentReq
	(*TeamRemoveAgentReq)(nil),     // 66: ratchet.TeamRemoveAgentReq
	(*TeamRenameReq)(nil),          // 67: ratchet.TeamRenameReq
	(*KillTeamReq)(nil),            // 68: ratchet.KillTeamReq
	(*AttachTeamReq)(nil),          // 69: ratchet.AttachTeamReq
	(*TeamActivityEvent)(nil),      // 70: ratchet.TeamActivityEvent
	(*HumanRequest)(nil),           // 71: ratchet.HumanRequest
	(*HumanResponse)(nil),          // 72: ratchet.HumanResponse
	(*PendingHumanReq)(nil),        // 73: ratchet.PendingHumanReq
	(*PendingHumanList)(nil),       // 74: ratchet.PendingHumanList
	(*SteerTeamReq)(nil),           // 75: ratchet.SteerTeamReq
	(*DirectMessageReq)(nil),       // 76: ratchet.DirectMessageReq
	(*StartProjectReq)(nil),        // 77: ratchet.StartProjectReq
	(*ProjectStatus)(nil),          // 78: ratchet.ProjectStatus
	(*ProjectList)(nil),            // 79: ratchet.ProjectList
	(*ProjectReq)(nil),             // 80: ratchet.ProjectReq
	(*TaskCreateReq)(nil),          // 81: ratchet.TaskCreateReq
	(*TaskUpdateReq)(nil),          // 82: ratchet.TaskUpdateReq
	(*TaskClaimReq)(nil),           // 83: ratchet.TaskClaimReq
	(*TaskListReq)(nil),            // 84: ratchet.TaskListReq
	(*TaskInfo)(nil),               // 85: ratchet.TaskInfo
	(*TaskList)(nil),               // 86: ratchet.TaskList
	(*TaskReq)(nil),                // 87: ratchet.TaskReq
	nil,                            // 88: ratchet.Job.MetadataEntry
	(*timestamppb.Timestamp)(nil),  // 89: google.protobuf.Timestamp
}
var file_internal_proto_ratchet_proto_depIdxs = []int32{
	89,  // 0: ratchet.Session.created_at:type_name -> google.protobuf.Timestamp
	...
	89,  // 18: ratchet.HistoryMessage.timestamp:type_name -> google.protobuf.Timestamp
	...
	88,  // 33: ratchet.Job.metadata:type_name -> ratchet.Job.MetadataEntry
	...
	37,  // 38: ratchet.TeamList.teams:type_name -> ratchet.TeamStatus
	18,  // 39: ratchet.TeamActivityEvent.agent_message:type_name -> ratchet.AgentMessage
	12,  // 40: ratchet.TeamActivityEvent.token:type_name -> ratchet.TokenDelta
	20,  // 41: ratchet.TeamActivityEvent.error:type_name -> ratchet.ErrorEvent
	19,  // 42: ratchet.TeamActivityEvent.complete:type_name -> ratchet.SessionComplete
	71,  // 43: ratchet.TeamActivityEvent.human_request:type_name -> ratchet.HumanRequest
	71,  // 44: ratchet.PendingHumanList.requests:type_name -> ratchet.HumanRequest
	78,  // 45: ratchet.ProjectList.projects:type_name -> ratchet.ProjectStatus
	85,  // 46: ratchet.TaskList.tasks:type_name -> ratchet.TaskInfo
	2,   // 47: ratchet.RatchetDaemon.CreateSession:input_type -> ratchet.CreateSessionReq
	0,   // 48: ratchet.RatchetDaemon.ListSessions:input_type -> ratchet.Empty
	4,   // 49: ratchet.RatchetDaemon.AttachSession:input_type -> ratchet.AttachReq
	5,   // 50: ratchet.RatchetDaemon.DetachSession:input_type -> ratchet.DetachReq
	6,   // 51: ratchet.RatchetDaemon.KillSession:input_type -> ratchet.KillReq
	7,   // 52: ratchet.RatchetDaemon.SendMessage:input_type -> ratchet.SendMessageReq
	16,  // 53: ratchet.RatchetDaemon.RespondToPermission:input_type -> ratchet.PermissionResponse
	23,  // 54: ratchet.RatchetDaemon.AddProvider:input_type -> ratchet.AddProviderReq
	0,   // 55: ratchet.RatchetDaemon.ListProviders:input_type -> ratchet.Empty
	26,  // 56: ratchet.RatchetDaemon.TestProvider:input_type -> ratchet.TestProviderReq
	28,  // 57: ratchet.RatchetDaemon.RemoveProvider:input_type -> ratchet.RemoveProviderReq
	29,  // 58: ratchet.RatchetDaemon.SetDefaultProvider:input_type -> ratchet.SetDefaultProviderReq
	30,  // 59: ratchet.RatchetDaemon.UpdateProviderModel:input_type -> ratchet.UpdateProviderModelReq
	0,   // 60: ratchet.RatchetDaemon.ListAgents:input_type -> ratchet.Empty
	33,  // 61: ratchet.RatchetDaemon.GetAgentStatus:input_type -> ratchet.AgentStatusReq
	34,  // 62: ratchet.RatchetDaemon.StartTeam:input_type -> ratchet.StartTeamReq
	36,  // 63: ratchet.RatchetDaemon.GetTeamStatus:input_type -> ratchet.TeamStatusReq
	40,  // 64: ratchet.RatchetDaemon.ApprovePlan:input_type -> ratchet.ApprovePlanReq
	41,  // 65: ratchet.RatchetDaemon.RejectPlan:input_type -> ratchet.RejectPlanReq
	46,  // 66: ratchet.RatchetDaemon.StartFleet:input_type -> ratchet.StartFleetReq
	49,  // 67: ratchet.RatchetDaemon.GetFleetStatus:input_type -> ratchet.FleetStatusReq
	50,  // 68: ratchet.RatchetDaemon.KillFleetWorker:input_type -> ratchet.KillFleetWorkerReq
	43,  // 69: ratchet.RatchetDaemon.CreateCron:input_type -> ratchet.CreateCronReq
	0,   // 70: ratchet.RatchetDaemon.ListCrons:input_type -> ratchet.Empty
	45,  // 71: ratchet.RatchetDaemon.PauseCron:input_type -> ratchet.CronJobReq
	45,  // 72: ratchet.RatchetDaemon.ResumeCron:input_type -> ratchet.CronJobReq
	45,  // 73: ratchet.RatchetDaemon.StopCron:input_type -> ratchet.CronJobReq
	0,   // 74: ratchet.RatchetDaemon.ListJobs:input_type -> ratchet.Empty
	53,  // 75: ratchet.RatchetDaemon.PauseJob:input_type -> ratchet.JobReq
	53,  // 76: ratchet.RatchetDaemon.ResumeJob:input_type -> ratchet.JobReq
	53,  // 77: ratchet.RatchetDaemon.KillJob:input_type -> ratchet.JobReq
	0,   // 78: ratchet.RatchetDaemon.Health:input_type -> ratchet.Empty
	0,   // 79: ratchet.RatchetDaemon.Shutdown:input_type -> ratchet.Empty
	55,  // 80: ratchet.RatchetDaemon.CheckVersion:input_type -> ratchet.VersionCheckReq
	57,  // 81: ratchet.RatchetDaemon.RequestReload:input_type -> ratchet.ReloadReq
	59,  // 82: ratchet.RatchetDaemon.RegisterMeshNode:input_type -> ratchet.RegisterNodeReq
	62,  // 83: ratchet.RatchetDaemon.MeshStream:input_type -> ratchet.MeshEvent
	63,  // 84: ratchet.RatchetDaemon.ListTeams:input_type -> ratchet.ListTeamsReq
	68,  // 85: ratchet.RatchetDaemon.KillTeam:input_type -> ratchet.KillTeamReq
	67,  // 86: ratchet.RatchetDaemon.RenameTeam:input_type -> ratchet.TeamRenameReq
	65,  // 87: ratchet.RatchetDaemon.TeamAddAgent:input_type -> ratchet.TeamAddAgentReq
	66,  // 88: ratchet.RatchetDaemon.TeamRemoveAgent:input_type -> ratchet.TeamRemoveAgentReq
	69,  // 89: ratchet.RatchetDaemon.AttachTeam:input_type -> ratchet.AttachTeamReq
	75,  // 90: ratchet.RatchetDaemon.SteerTeam:input_type -> ratchet.SteerTeamReq
	76,  // 91: ratchet.RatchetDaemon.DirectMessage:input_type -> ratchet.DirectMessageReq
	72,  // 92: ratchet.RatchetDaemon.RespondToHuman:input_type -> ratchet.HumanResponse
	73,  // 93: ratchet.RatchetDaemon.ListPendingHuman:input_type -> ratchet.PendingHumanReq
	77,  // 94: ratchet.RatchetDaemon.StartProject:input_type -> ratchet.StartProjectReq
	0,   // 95: ratchet.RatchetDaemon.ListProjects:input_type -> ratchet.Empty
	80,  // 96: ratchet.RatchetDaemon.PauseProject:input_type -> ratchet.ProjectReq
	80,  // 97: ratchet.RatchetDaemon.ResumeProject:input_type -> ratchet.ProjectReq
	80,  // 98: ratchet.RatchetDaemon.KillProject:input_type -> ratchet.ProjectReq
	80,  // 99: ratchet.RatchetDaemon.GetProjectStatus:input_type -> ratchet.ProjectReq
	81,  // 100: ratchet.RatchetDaemon.CreateTask:input_type -> ratchet.TaskCreateReq
	83,  // 101: ratchet.RatchetDaemon.ClaimTask:input_type -> ratchet.TaskClaimReq
	82,  // 102: ratchet.RatchetDaemon.UpdateTask:input_type -> ratchet.TaskUpdateReq
	84,  // 103: ratchet.RatchetDaemon.ListTasks:input_type -> ratchet.TaskListReq
	87,  // 104: ratchet.RatchetDaemon.GetTask:input_type -> ratchet.TaskReq
	1,   // 105: ratchet.RatchetDaemon.CreateSession:output_type -> ratchet.Session
	3,   // 106: ratchet.RatchetDaemon.ListSessions:output_type -> ratchet.SessionList
	8,   // 107: ratchet.RatchetDaemon.AttachSession:output_type -> ratchet.ChatEvent
	0,   // 108: ratchet.RatchetDaemon.DetachSession:output_type -> ratchet.Empty
	0,   // 109: ratchet.RatchetDaemon.KillSession:output_type -> ratchet.Empty
	8,   // 110: ratchet.RatchetDaemon.SendMessage:output_type -> ratchet.ChatEvent
	0,   // 111: ratchet.RatchetDaemon.RespondToPermission:output_type -> ratchet.Empty
	24,  // 112: ratchet.RatchetDaemon.AddProvider:output_type -> ratchet.Provider
	25,  // 113: ratchet.RatchetDaemon.ListProviders:output_type -> ratchet.ProviderList
	27,  // 114: ratchet.RatchetDaemon.TestProvider:output_type -> ratchet.TestProviderResult
	0,   // 115: ratchet.RatchetDaemon.RemoveProvider:output_type -> ratchet.Empty
	0,   // 116: ratchet.RatchetDaemon.SetDefaultProvider:output_type -> ratchet.Empty
	0,   // 117: ratchet.RatchetDaemon.UpdateProviderModel:output_type -> ratchet.Empty
	32,  // 118: ratchet.RatchetDaemon.ListAgents:output_type -> ratchet.AgentList
	31,  // 119: ratchet.RatchetDaemon.GetAgentStatus:output_type -> ratchet.Agent
	35,  // 120: ratchet.RatchetDaemon.StartTeam:output_type -> ratchet.TeamEvent
	37,  // 121: ratchet.RatchetDaemon.GetTeamStatus:output_type -> ratchet.TeamStatus
	8,   // 122: ratchet.RatchetDaemon.ApprovePlan:output_type -> ratchet.ChatEvent
	0,   // 123: ratchet.RatchetDaemon.RejectPlan:output_type -> ratchet.Empty
	8,   // 124: ratchet.RatchetDaemon.StartFleet:output_type -> ratchet.ChatEvent
	48,  // 125: ratchet.RatchetDaemon.GetFleetStatus:output_type -> ratchet.FleetStatus
	0,   // 126: ratchet.RatchetDaemon.KillFleetWorker:output_type -> ratchet.Empty
	42,  // 127: ratchet.RatchetDaemon.CreateCron:output_type -> ratchet.CronJob
	44,  // 128: ratchet.RatchetDaemon.ListCrons:output_type -> ratchet.CronJobList
	0,   // 129: ratchet.RatchetDaemon.PauseCron:output_type -> ratchet.Empty
	0,   // 130: ratchet.RatchetDaemon.ResumeCron:output_type -> ratchet.Empty
	0,   // 131: ratchet.RatchetDaemon.StopCron:output_type -> ratchet.Empty
	52,  // 132: ratchet.RatchetDaemon.ListJobs:output_type -> ratchet.JobList
	0,   // 133: ratchet.RatchetDaemon.PauseJob:output_type -> ratchet.Empty
	0,   // 134: ratchet.RatchetDaemon.ResumeJob:output_type -> ratchet.Empty
	0,   // 135: ratchet.RatchetDaemon.KillJob:output_type -> ratchet.Empty
	54,  // 136: ratchet.RatchetDaemon.Health:output_type -> ratchet.HealthResponse
	0,   // 137: ratchet.RatchetDaemon.Shutdown:output_type -> ratchet.Empty
	56,  // 138: ratchet.RatchetDaemon.CheckVersion:output_type -> ratchet.VersionCheckResp
	58,  // 139: ratchet.RatchetDaemon.RequestReload:output_type -> ratchet.ReloadStatus
	60,  // 140: ratchet.RatchetDaemon.RegisterMeshNode:output_type -> ratchet.RegisterNodeResp
	62,  // 141: ratchet.RatchetDaemon.MeshStream:output_type -> ratchet.MeshEvent
	64,  // 142: ratchet.RatchetDaemon.ListTeams:output_type -> ratchet.TeamList
	0,   // 143: ratchet.RatchetDaemon.KillTeam:output_type -> ratchet.Empty
	0,   // 144: ratchet.RatchetDaemon.RenameTeam:output_type -> ratchet.Empty
	0,   // 145: ratchet.RatchetDaemon.TeamAddAgent:output_type -> ratchet.Empty
	0,   // 146: ratchet.RatchetDaemon.TeamRemoveAgent:output_type -> ratchet.Empty
	70,  // 147: ratchet.RatchetDaemon.AttachTeam:output_type -> ratchet.TeamActivityEvent
	0,   // 148: ratchet.RatchetDaemon.SteerTeam:output_type -> ratchet.Empty
	0,   // 149: ratchet.RatchetDaemon.DirectMessage:output_type -> ratchet.Empty
	0,   // 150: ratchet.RatchetDaemon.RespondToHuman:output_type -> ratchet.Empty
	74,  // 151: ratchet.RatchetDaemon.ListPendingHuman:output_type -> ratchet.PendingHumanList
	78,  // 152: ratchet.RatchetDaemon.StartProject:output_type -> ratchet.ProjectStatus
	79,  // 153: ratchet.RatchetDaemon.ListProjects:output_type -> ratchet.ProjectList
	0,   // 154: ratchet.RatchetDaemon.PauseProject:output_type -> ratchet.Empty
	0,   // 155: ratchet.RatchetDaemon.ResumeProject:output_type -> ratchet.Empty
	0,   // 156: ratchet.RatchetDaemon.KillProject:output_type -> ratchet.Empty
	78,  // 157: ratchet.RatchetDaemon.GetProjectStatus:output_type -> ratchet.ProjectStatus
	85,  // 158: ratchet.RatchetDaemon.CreateTask:output_type -> ratchet.TaskInfo
	85,  // 159: ratchet.RatchetDaemon.ClaimTask:output_type -> ratchet.TaskInfo
	85,  // 160: ratchet.RatchetDaemon.UpdateTask:output_type -> ratchet.TaskInfo
	86,  // 161: ratchet.RatchetDaemon.ListTasks:output_type -> ratchet.TaskList
	85,  // 162: ratchet.RatchetDaemon.GetTask:output_type -> ratchet.TaskInfo
