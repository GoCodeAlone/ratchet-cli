...
var file_internal_proto_ratchet_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_internal_proto_ratchet_proto_goTypes = []any{
	...
	(*RegisterNodeReq)(nil),        // 58: ratchet.RegisterNodeReq
	(*RegisterNodeResp)(nil),       // 59: ratchet.RegisterNodeResp
	(*BlackboardSync)(nil),         // 60: ratchet.BlackboardSync
	(*MeshEvent)(nil),              // 61: ratchet.MeshEvent
	nil,                            // 62: ratchet.Job.MetadataEntry
	(*timestamppb.Timestamp)(nil),  // 63: google.protobuf.Timestamp
}
var file_internal_proto_ratchet_proto_depIdxs = []int32{
	63, // 0: ratchet.Session.created_at:type_name -> google.protobuf.Timestamp
	...
	63, // 18: ratchet.HistoryMessage.timestamp:type_name -> google.protobuf.Timestamp
	...
	62, // 33: ratchet.Job.metadata:type_name -> ratchet.Job.MetadataEntry
	50, // 34: ratchet.JobList.jobs:type_name -> ratchet.Job
	60, // 35: ratchet.MeshEvent.blackboard_sync:type_name -> ratchet.BlackboardSync
	18, // 36: ratchet.MeshEvent.agent_message:type_name -> ratchet.AgentMessage
	59, // 37: ratchet.MeshEvent.node_registered:type_name -> ratchet.RegisterNodeResp
	...
	0,  // 50: ratchet.RatchetDaemon.ListAgents:input_type -> ratchet.Empty
	32, // 51: ratchet.RatchetDaemon.GetAgentStatus:input_type -> ratchet.AgentStatusReq
	33, // 52: ratchet.RatchetDaemon.StartTeam:input_type -> ratchet.StartTeamReq
	35, // 53: ratchet.RatchetDaemon.GetTeamStatus:input_type -> ratchet.TeamStatusReq
	39, // 54: ratchet.RatchetDaemon.ApprovePlan:input_type -> ratchet.ApprovePlanReq
	40, // 55: ratchet.RatchetDaemon.RejectPlan:input_type -> ratchet.RejectPlanReq
	45, // 56: ratchet.RatchetDaemon.StartFleet:input_type -> ratchet.StartFleetReq
	48, // 57: ratchet.RatchetDaemon.GetFleetStatus:input_type -> ratchet.FleetStatusReq
	49, // 58: ratchet.RatchetDaemon.KillFleetWorker:input_type -> ratchet.KillFleetWorkerReq
	42, // 59: ratchet.RatchetDaemon.CreateCron:input_type -> ratchet.CreateCronReq
	0,  // 60: ratchet.RatchetDaemon.ListCrons:input_type -> ratchet.Empty
	44, // 61: ratchet.RatchetDaemon.PauseCron:input_type -> ratchet.CronJobReq
	44, // 62: ratchet.RatchetDaemon.ResumeCron:input_type -> ratchet.CronJobReq
	44, // 63: ratchet.RatchetDaemon.StopCron:input_type -> ratchet.CronJobReq
	0,  // 64: ratchet.RatchetDaemon.ListJobs:input_type -> ratchet.Empty
	52, // 65: ratchet.RatchetDaemon.PauseJob:input_type -> ratchet.JobReq
	52, // 66: ratchet.RatchetDaemon.ResumeJob:input_type -> ratchet.JobReq
	52, // 67: ratchet.RatchetDaemon.KillJob:input_type -> ratchet.JobReq
	0,  // 68: ratchet.RatchetDaemon.Health:input_type -> ratchet.Empty
	0,  // 69: ratchet.RatchetDaemon.Shutdown:input_type -> ratchet.Empty
	54, // 70: ratchet.RatchetDaemon.CheckVersion:input_type -> ratchet.VersionCheckReq
	56, // 71: ratchet.RatchetDaemon.RequestReload:input_type -> ratchet.ReloadReq
	58, // 72: ratchet.RatchetDaemon.RegisterMeshNode:input_type -> ratchet.RegisterNodeReq
	61, // 73: ratchet.RatchetDaemon.MeshStream:input_type -> ratchet.MeshEvent
	1,  // 74: ratchet.RatchetDaemon.CreateSession:output_type -> ratchet.Session
	3,  // 75: ratchet.RatchetDaemon.ListSessions:output_type -> ratchet.SessionList
	8,  // 76: ratchet.RatchetDaemon.AttachSession:output_type -> ratchet.ChatEvent
	0,  // 77: ratchet.RatchetDaemon.DetachSession:output_type -> ratchet.Empty
	0,  // 78: ratchet.RatchetDaemon.KillSession:output_type -> ratchet.Empty
	8,  // 79: ratchet.RatchetDaemon.SendMessage:output_type -> ratchet.ChatEvent
	0,  // 80: ratchet.RatchetDaemon.RespondToPermission:output_type -> ratchet.Empty
	24, // 81: ratchet.RatchetDaemon.AddProvider:output_type -> ratchet.Provider
	25, // 82: ratchet.RatchetDaemon.ListProviders:output_type -> ratchet.ProviderList
	27, // 83: ratchet.RatchetDaemon.TestProvider:output_type -> ratchet.TestProviderResult
	0,  // 84: ratchet.RatchetDaemon.RemoveProvider:output_type -> ratchet.Empty
	0,  // 85: ratchet.RatchetDaemon.SetDefaultProvider:output_type -> ratchet.Empty
	31, // 86: ratchet.RatchetDaemon.ListAgents:output_type -> ratchet.AgentList
	30, // 87: ratchet.RatchetDaemon.GetAgentStatus:output_type -> ratchet.Agent
	34, // 88: ratchet.RatchetDaemon.StartTeam:output_type -> ratchet.TeamEvent
	36, // 89: ratchet.RatchetDaemon.GetTeamStatus:output_type -> ratchet.TeamStatus
	8,  // 90: ratchet.RatchetDaemon.ApprovePlan:output_type -> ratchet.ChatEvent
	0,  // 91: ratchet.RatchetDaemon.RejectPlan:output_type -> ratchet.Empty
	8,  // 92: ratchet.RatchetDaemon.StartFleet:output_type -> ratchet.ChatEvent
	47, // 93: ratchet.RatchetDaemon.GetFleetStatus:output_type -> ratchet.FleetStatus
	0,  // 94: ratchet.RatchetDaemon.KillFleetWorker:output_type -> ratchet.Empty
	41, // 95: ratchet.RatchetDaemon.CreateCron:output_type -> ratchet.CronJob
	43, // 96: ratchet.RatchetDaemon.ListCrons:output_type -> ratchet.CronJobList
	0,  // 97: ratchet.RatchetDaemon.PauseCron:output_type -> ratchet.Empty
	0,  // 98: ratchet.RatchetDaemon.ResumeCron:output_type -> ratchet.Empty
	0,  // 99: ratchet.RatchetDaemon.StopCron:output_type -> ratchet.Empty
	51, // 100: ratchet.RatchetDaemon.ListJobs:output_type -> ratchet.JobList
	0,  // 101: ratchet.RatchetDaemon.PauseJob:output_type -> ratchet.Empty
	0,  // 102: ratchet.RatchetDaemon.ResumeJob:output_type -> ratchet.Empty
	0,  // 103: ratchet.RatchetDaemon.KillJob:output_type -> ratchet.Empty
	53, // 104: ratchet.RatchetDaemon.Health:output_type -> ratchet.HealthResponse
	0,  // 105: ratchet.RatchetDaemon.Shutdown:output_type -> ratchet.Empty
	55, // 106: ratchet.RatchetDaemon.CheckVersion:output_type -> ratchet.VersionCheckResp
	57, // 107: ratchet.RatchetDaemon.RequestReload:output_type -> ratchet.ReloadStatus
	59, // 108: ratchet.RatchetDaemon.RegisterMeshNode:output_type -> ratchet.RegisterNodeResp
	61, // 109: ratchet.RatchetDaemon.MeshStream:output_type -> ratchet.MeshEvent
...
func file_internal_proto_ratchet_proto_init() {
	...
	file_internal_proto_ratchet_proto_msgTypes[61].OneofWrappers = []any{
