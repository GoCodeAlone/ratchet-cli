module github.com/GoCodeAlone/ratchet-cli
...
require (
	...
	github.com/GoCodeAlone/workflow-plugin-agent v0.12.10
...
require (
	...
	github.com/GoCodeAlone/workflow-plugin-authz v0.6.0 // indirect
